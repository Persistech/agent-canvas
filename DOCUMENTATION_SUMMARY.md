...
src/extensions/
├── README.md              # Implementation reference (kept as authoritative)
└── DEPRECATION_NOTICE.md  # Notes about potential conflicts with new docs
```

**Note:** Example extensions (`hello-sidebar`, `sandboxes`) have been moved to a dedicated repository:
[jpshackelford/agent-canvas-experimental-extensions](https://github.com/jpshackelford/agent-canvas-experimental-extensions)
