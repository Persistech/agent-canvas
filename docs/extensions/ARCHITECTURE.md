...
- Nested structures (viewsContainers, views, commands, menus, settingsPages)
...
For development, Vite serves extension assets from `examples/extensions/` at `/__extensions/*`.
