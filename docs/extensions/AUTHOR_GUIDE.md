...
See [`examples/extensions/hello-sidebar/`](../../examples/extensions/hello-sidebar/) for a complete working example.
...
Agent Canvas automatically injects CSS custom properties for theming:
...
--oh-border-subtle
--oh-primary
--oh-primary-foreground
--oh-font-family
/* ... and more */
```

Call `enableHostTheme()` from the SDK to receive theme updates.
...
See [`examples/extensions/hello-sidebar/`](../../examples/extensions/hello-sidebar/) for a complete, working extension that demonstrates:
