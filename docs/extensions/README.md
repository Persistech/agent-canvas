...
- **Example extensions:** [jpshackelford/agent-canvas-experimental-extensions](https://github.com/jpshackelford/agent-canvas-experimental-extensions)
  - `hello-sidebar` — Minimal working sample demonstrating all contribution points
  - `sandboxes` — Cloud sandbox management extension
...
- ✅ Settings pages
- ✅ Full-width sidebar pages (`contributes.pages`)
- ✅ Conversation panel tabs (`contributes.conversationPanelTabs`)
- ✅ Cloud backend API access (`backend:cloud:read/write`)
